"""
RoundTable Content Generator

Orchestrates LLM content generation for round_table illustrations.
...
from app.core.round_table_validator import get_validator

logger = logging.getLogger(__name__)


class RoundTableGenerator:
    """Generates round_table content using LLM"""

    EXPECTED_FIELDS = [
        "element_1_label", "element_1_bullet_1", "element_1_bullet_2",
        "element_2_label", "element_2_bullet_1", "element_2_bullet_2",
        "element_3_label", "element_3_bullet_1", "element_3_bullet_2",
        "element_4_label", "element_4_bullet_1", "element_4_bullet_2",
        "element_5_label", "element_5_bullet_1", "element_5_bullet_2",
        "element_6_label", "element_6_bullet_1", "element_6_bullet_2",
        "element_7_label", "element_7_bullet_1", "element_7_bullet_2",
        "element_8_label", "element_8_bullet_1", "element_8_bullet_2"
    ]
    ...
    async def generate_round_table_data(
        self,
        num_elements: int,
        topic: str,
        ...
        """
        Generate round_table content with LLM.
        ...
        for attempt in range(max_retries + 1):
            logger.info(f"Generating round_table content (attempt {attempt + 1}/{max_retries + 1})")
    ...
    def _build_prompt(
        ...
        return f"""Generate content for a "Round Table" illustration about: {topic}
...
2. Bullets: Follow the character constraints EXACTLY (excluding <strong> tags)
   - Count only visible text, NOT the HTML tags
   - Each bullet must have ONE key phrase wrapped in <strong> tags
...
_generator: RoundTableGenerator = None


def get_generator() -> RoundTableGenerator:
    """Get or create the global generator instance"""
    global _generator
    if _generator is None:
        _generator = RoundTableGenerator()
    return _generator
